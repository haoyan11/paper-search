...
> **中文提问，0.14秒找到英文论文。1244篇文献，完全本地运行，零成本，数据不上传。**

面向非 CS 研究生的本地 PDF 文献语义搜索工具。
...
```
$ python3 demo_search.py "植被物候对蒸散发的影响"
  ...
  1  ████████░░░░  0.717   Evapotranspiration increase is more sensitive to vegetation greening...
                           2025 · 英文 · Zhu Yixuan 等 (8人)

  2  ████████░░░░  0.696   Direct and indirect effects of spring phenology on forest transpiration
                           2025 · 英文 · Wang Lvlv

  3  ████████░░░░  0.686   Warming-induced shifts in vegetation phenology affect hydrological cycle
                           2022 · 英文
```
...
```bash
# 中文查询（推荐）
python3 demo_search.py "物候对径流的影响机制"

# 中英双语查询（更精准）
python3 demo_search.py "生长季延长水文效应" --also "growing season length evapotranspiration"

# 纯英文
python3 demo_search.py "phenology hydrological response attribution"

# 返回更多结果（默认5篇）
python3 search_papers.py "植被蒸散发" --top 10
```
...
└── paper_embeddings.npz   ← 语义向量矩阵（1244篇 × 384维，约 1.7MB）
```
...
- 有 100~2000 篇本地 PDF 文献的研究生
- 需要用中文思路检索英文文献（水文、生态、环境、地理等非 CS 方向）
